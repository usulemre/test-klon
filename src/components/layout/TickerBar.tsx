  ...
  return (
    <div className="border-b border-market-border bg-market-bg text-white">
      <div className="mx-auto flex max-w-[1400px] items-center gap-3 px-4">
        <span className="hidden shrink-0 items-center gap-1.5 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-gold-400 sm:flex">
          <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-market-up" />
          Canlı Piyasa
        </span>
